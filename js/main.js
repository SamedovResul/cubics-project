...
const questionArray = ['Uşaq ixtiraçı bunlardan hansını kəşf edib?']
question.innerHTML = questionArray
const answerArray = {
    One:[ 'Buzlu şəkər', 'Kağız','Robot' ,'İpək'],
    Two:[ 'Kitab', 'Üzgəc','Şokolad' ,'Təyyarə'],
    Three:[ 'Qələm', 'Konfet ', 'Qar arabası' ,'Yapışqan'],
}
